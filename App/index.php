...
// Admin Tags Routes
$app->route->add('/admin/tags', 'Admin/Tags');
$app->route->add('/admin/tags/add', 'Admin/Tags@add', 'POST');
$app->route->add('/admin/tags/submit', 'Admin/Tags@submit', 'POST');
$app->route->add('/admin/tags/edit/:id', 'Admin/Tags@edit', 'POST');
$app->route->add('/admin/tags/save/:id', 'Admin/Tags@save' , 'POST');
$app->route->add('/admin/tags/delete/:id', 'Admin/Tags@delete', 'POST');
...
$app->route->add('/Tags/:text/:id', 'Blog/Tags');
